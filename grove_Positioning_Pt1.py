...
# Runs through file, adding the numbers to the first list and their index/order to the first
while 1:
    s = f.readline()
    if not s:
        break
...
# Runs through each element and looks for the one to do then moves it accordingly
