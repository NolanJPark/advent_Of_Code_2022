...
that a crane will be taking. The crane moves them one at a time instead of a whole group at once.
*/
import java.io.File;
import java.io.FileNotFoundException;
import java.util.*;
public class supply_Stacks_Pt1
{
